...
public class InvoicesDB {
	...
	public static int getUnCheckInvoiceByTableID(int tableId) throws Exception {
	...
	public static Boolean Insert(int tableID, int accountID) throws Exception {
		Connection connection = controller.ConnectDatabase.ConnectMySQLSever();
	...
	public static boolean Update(int tableID, int totalPrice) throws Exception {
		if (getUnCheckInvoiceByTableID(tableID) != -1) {
			Connection connection = controller.ConnectDatabase.ConnectMySQLSever();
